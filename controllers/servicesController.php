...
$pathNFefile = "C:/wamp/www/gesfin/nfe/files/nfe/homologacao/assinadas/{$chave}-nfe.xml";
if (! $indSinc) {
    $pathProtfile = "C:/wamp/www/gesfin/nfe/files/nfe/homologacao/temporarias/2017/{$recibo}-retConsReciNFe.xml";
} else {
    $pathProtfile = "C:/wamp/www/gesfin/nfe/files/nfe/homologacao/temporarias/2017/{$recibo}-retEnviNFe.xml";
}
$saveFile = true;
