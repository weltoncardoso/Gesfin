...
<div class="db-row row2">
  ...
  <div class="grid-1">
		<div class="db-info">
			<div class="db-info-title">Status dos Serviços</div>
			<div class="db-info-body">
				<canvas id="rel2_1" height="325"> </canvas>
			</div>
		</div>
    </div>
</div>
...
<script type="text/javascript">
	...
	var status_list_services = <?php echo json_encode(array_values($status_list_services)) ?>;
