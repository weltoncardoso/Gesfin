...
$(function(){
	...
	$('input[name=total_price').mask('000.000.000.000,00', {reverse:true, placeholder:"0,00"});
	...
	$('.client_add_button').on('click', function(e){
		...
		if (name != '' && name.length >= 4) {
			...
			if (confirm('Deseja adicionar um Cliente com o nome: '+name+' ?')) {

				alert("Adicionando o Cliente: "+name);
